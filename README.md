...
## ⚠️ 考試期間 禁止使用 AI 來回答任何考試內容

> **重要提醒：** 禁止在 "考試期間" 都使用「AI」來完成考題，都用 AI 本公司就不需要聘任工程師，直接聘任中文系來詢問 AI 來完成專案即可。如果你連考題都用 AI 來回應即代表你連「自我學習與要求」都不具備當 程式設計師 能力。<BR><BR>
